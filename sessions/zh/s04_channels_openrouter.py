"""
第04节: 通道 -- "同一大脑, 多个嘴巴" (OpenRouter版本)
...
运行方法:  cd claw0 && python sessions/zh/s04_channels_openrouter.py
...
class FeishuChannel(Channel):
    ...
    def __init__(self, account: ChannelAccount) -> None:
        ...
        self._http = httpx.Client(timeout=15.0, verify=ssl_context)
        ...
        if finish_reason == "stop":
            if assistant_content:
                ...
                if ch:
                    ...
                    print_assistant(assistant_content, inbound.channel)
            break
